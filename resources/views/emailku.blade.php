                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/855450_839519/editor_images/25d584ec-039e-417a-bcd7-d6ee02888f48.png"
                                                                        style="display: block; height: auto; border: 0; width: 204px; max-width: 100%;"
                                                                        width="204" alt="Yourlogo Light"
                                                                        title="Yourlogo Light"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table class="image_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4971/check-icon.png"
                                                                        style="display: block; height: auto; border: 0; width: 93px; max-width: 100%;"
                                                                        width="93" alt="Check Icon"
                                                                        title="Check Icon"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:30px;">{{ $data['pesan_status'] }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:16px;">
                                                                                {{ is_null($data['pengaju']) ? '' : 'Ormawa Pengaju:' . $data['pengaju'] }}
                                                                            </span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                ...
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="button_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div class="alignment" align="center">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://127.0.0.1:8000/dashboard/pengajuan" style="height:42px;width:155px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#8a3c90"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
                                                                        href="http://127.0.0.1:8000/dashboard/pengajuan"
                                                                        target="_blank"
                                                                        style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#8a3c90;border-radius:4px;width:auto;border-top:1px solid #8a3c90;font-weight:400;border-right:1px solid #8a3c90;border-bottom:1px solid #8a3c90;border-left:1px solid #8a3c90;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                                            style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                dir="ltr"
                                                                                style="word-break: break-word; line-height: 32px;">Lihat
                                                                                Pengajuan</span></span></a>
                                                    ...
                                                    <table class="image_block block-2" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/855450_839519/logo-home.png"
                                                                        style="display: block; height: auto; border: 0; width: 204px; max-width: 100%;"
                                                                        width="204" alt="Yourlogo Light"
                                                                        title="Yourlogo Light"></div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div class="alignment" style="text-align:center;">
                                                                    <table class="social-table" width="108px"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:12px;">Jl. Maulana
                                                                                Yusuf No. 10 Babakan Kota Tangerang,
                                                                                Banten 15118</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                            <span
                                                                                style="font-size:12px;">unis.ac.id</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 12px; text-align: center;">
                                                                            021-5527061, 5527063,</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
