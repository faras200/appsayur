...
<head>
    ...
    <link href="assets/css/material-kit.min.css?v=2.2.1" rel="stylesheet" />
...
<body class="blog-posts sidebar-collapse">
    ...
    <div class="page-header header-filter header-small" data-parallax="true"
        style="background-image: url('assets/img/bg10.jpg');">
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-raised card-background"
                            ...
                            <div class="card-body">
                                ...
                                <a href="#pablo" class="btn btn-white btn-just-icon btn-link" title="" rel="tooltip"
    ...
    <script src="assets/js/material-kit.min.js?v=2.2.1" type="text/javascript"></script>
</body>
