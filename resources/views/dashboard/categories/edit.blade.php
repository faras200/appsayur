    ...
    <div class="row">
        <div class="col-md-12" style="padding: 0px 0px !important">
            <div class="card ">
                ...
                <div class="card-body ">
                    <form method="post" action="/dashboard/categories/{{ $category->slug }}" class="form-horizontal">
                        @method('put')
                        @csrf
                            ...
                            <div class="col-md-9">
                                <div class="form-group has-default">
                                    <input type="text" name="slug" id="slug" class="form-control"
                                        value="{{ old('slug', $category->name) }}" required>
                                    @error('slug')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                ...
                <div class="card-footer justify-content-center">
                    <div class="row ">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-fill btn-rose">Edit Category</button>
                        </div>
                    </div>
                </div>
                </form>
