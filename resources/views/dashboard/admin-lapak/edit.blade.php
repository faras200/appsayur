        ...
        <div class="col-md-12" style="padding: 0px 0px !important">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Ubah Admin Lapak</h4>
                </div>
                <div class="card-body mt-4">
                    <form method="post" action="/dashboard/admin-lapak/{{ $admin->id }}" class="form-horizontal">
                        @method('put')
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group ">
                                    <label for="">Tanggung Jawab Lapak</label>
                                    <select id="ormawa" name="lapak_id" class="form-control mt-4"
                                        aria-label="With textarea">
                                        <option value="{{ $admin->lapak_id }}" selected>{{ $admin->lapak->nama }}
                                        </option>
