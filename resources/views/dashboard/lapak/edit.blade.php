        ...
        <div class="col-md-12" style="padding: 0px 0px !important">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Ubah Data Lapak</h4>
                </div>
                <div class="card-body mt-4">
                    <form method="post" action="/dashboard/lapak/{{ $lapak->id }}" class="form-horizontal">
                        @method('put')
                        @csrf
                        <div class="row">
