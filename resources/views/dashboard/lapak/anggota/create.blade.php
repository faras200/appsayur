        ...
        <div class="col-md-12" style="padding: 0px 0px !important">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Tambah Anggota Ormawa</h4>
                </div>
                <div class="card-body mt-4">

                    <form method="post" action="/dashboard/ormawa/anggota" class="form-horizontal">
                        @csrf
                        <input type="hidden" name="ormawa_id" value="{{ $id }}">
                        <div class="row">
